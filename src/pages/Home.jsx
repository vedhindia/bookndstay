import { FaMapMarkerAlt, FaCalendarAlt, FaSearch, FaTag, FaPercent, FaWallet, FaBuilding, FaStar, FaShieldAlt, FaHeadset, FaThumbsUp, FaCrosshairs, FaCopy, FaCheck, FaChevronLeft, FaChevronRight } from 'react-icons/fa';
...
const Home = ({ state, actions }) => {
  ...
  useEffect(() => {
    ...
    const apply = () => setPopularPerPage(compute());
    apply();
